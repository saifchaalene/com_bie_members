 ...
 * @since  1.0.0
 */
class MembersdelegatecountryField extends \Joomla\CMS\Form\FormField
{
	/**
	 ...
	 * @since  1.0.0
	 */
	protected $type = 'membersdelegatecountry';
...
");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->name, Text::_($result->name));
		}
