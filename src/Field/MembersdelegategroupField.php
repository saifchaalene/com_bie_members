 ...
 * @since  1.0.0
 */
class MembersdelegategroupField extends \Joomla\CMS\Form\FormField
{
	/**
	 ...
	 * @since  1.0.0
	 */
	protected $type = 'membersdelegategroup';
...
");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->id, Text::_($result->title));
		}
