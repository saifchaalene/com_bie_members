 ...
 * @since  1.0.0
 */
class MembersdelegateorganisationField extends \Joomla\CMS\Form\FormField
{
	/**
	 ...
	 * @since  1.0.0
	 */
	protected $type = 'membersdelegateorganisation';
	...
	protected function getInput()
	{
		...
		$db->setQuery("SELECT id, display_name 
FROM civicrm_organisations
WHERE is_deleted = 0
...
");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->id, Text::_($result->display_name));
		}
