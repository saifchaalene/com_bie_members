...
<form
	action="<?php echo Route::_('index.php?option=com_bie_members&layout=denounce&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="delegate-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'general', Text::_('COM_BIE_MEMBERS_TITLE_DELEGATE', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('end_date'); ?>
                                <input type="hidden" name="jform[mid]" value="<?php echo $this->item->mid; ?>" />
